    ...
    <div class="main">
        ...
        <div class="content">
            ...
            <section class="trade-history-section">
                ...
                <p style="color:#ccc; margin-bottom: 20px; text-align: center;">Complete overview of all trading
                    activities</p>
                ...
                <div class="table-container" id="historyTableContainer">
                    <table class="history-table">
                        ...
                        <tbody>
                            <?php if (count($tradeHistory) === 0): ?>
                                <tr>
                                    <td colspan="7" class="no-data">
                                        No trade history found. Trades will appear here when users create, update, or delete
                                        skins.
                                    </td>
                                </tr>
                            <?php else: ?>
                    ...
                    <?php if (isset($viewData['pagination']) && $viewData['pagination']['total_pages'] > 1): ?>
                        <div class="pagination-container"
                            ...
                            // Previous Arrow
                            if ($current > 1): ?>
                                <a href="?page=<?= $current - 1 ?>" class="pagination-arrow" title="Previous Page"
                                    data-page="<?= $current - 1 ?>">
                                    <i class="fas fa-arrow-left"></i>
                                </a>
                            <?php else: ?>
                            ...
                            // Next Arrow
                            if ($current < $total): ?>
                                <a href="?page=<?= $current + 1 ?>" class="pagination-arrow" title="Next Page"
                                    data-page="<?= $current + 1 ?>">
                                    <i class="fas fa-arrow-right"></i>
                                </a>
                            <?php else: ?>
            ...
            <section class="trade-history-section" style="margin-top: 40px;">
                ...
                <p style="color:#ccc; margin-bottom: 20px; text-align: center;">All conversations between buyers and
                    sellers</p>

                <div class="stats-grid" style="margin-bottom: 30px;">
                    <div class="stat-card">
                        <div class="stat-label">Total Conversations</div>
                        <div class="stat-number"><?= number_format((int) $conversationStats['total_conversations']) ?>
                        </div>
                    </div>
                    <div class="stat-card">
                    ...
                    <div class="stat-card">
                        ...
                        <div class="stat-number"><?= number_format((int) $conversationStats['archived_messages']) ?>
                        </div>
                    </div>
                </div>
                            ...
                            <?php else: ?>
                                <?php foreach ($customConversations as $conv): ?>
                                    <tr class="history-row">
                                        ...
                                        <td><span
                                                class="username">@<?= htmlspecialchars($conv['buyer_name'] ?? 'Unknown') ?></span>
                                        </td>
                                        <td><span
                                                class="username">@<?= htmlspecialchars($conv['seller_name'] ?? 'Unknown') ?></span>
                                        </td>
                                        <td>
