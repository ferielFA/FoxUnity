            ...
            <tbody>
              <?php foreach ($subscribers as $s): ?>
                <tr>
                  ...
                  <td>
                    <button class="btn-edit" onclick='openEditModal(<?php echo json_encode($s); ?>)'>
                      <i class="fas fa-edit"></i> Edit
                    </button>
                    <button class="btn-delete" onclick='deleteSubscriber("<?php echo htmlspecialchars($s["email"]); ?>")'>
              ...
              <div class="checkbox-group">
                <?php foreach ($categories as $cat): ?>
                  <label class="checkbox-label">
                    <input type="checkbox" name="categories[]" value="<?php echo $cat['idCategorie']; ?>"
                      class="cat-checkbox">
