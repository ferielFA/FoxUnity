...
<head>
  ...
  <style>
    ...
    #cat-modal{display:none;position:fixed;inset:0;background:rgba(3,3,3,0.75);align-items:center;justify-content:center;z-index:9999;backdrop-filter:blur(4px);}
    #cat-modal .modal-content{background:linear-gradient(180deg,rgba(255,255,255,0.02),rgba(255,255,255,0.01));border:1px solid rgba(255,122,0,0.08);padding:20px;border-radius:10px;width:560px;max-width:95%;box-shadow:0 10px 30px rgba(0,0,0,0.35);}
            ...
            <table class="admin-table modern-table cat-table">
              ...
              <tbody>
                  ...
                  <tr>
                    ...
                    <td class="table-actions" style="white-space:nowrap;">
                      ...
                      <form style="display:inline" method="post" action="../../controller/CategoryController.php">
                        ...
                        <button class="btn pill-btn pill-secondary" style="font-size:0.8rem; padding:6px 10px;" type="submit">
                      ...
                      <!-- Delete Form -->
                      <form style="display:inline" method="post" action="../../controller/CategoryController.php" onsubmit="return confirm('Delete this category?');">
                ...
                <?php if(empty($categories)): ?>
                    <tr><td colspan="6" style="text-align:center; padding:20px; color:#666;">No categories found.</td></tr>
                <?php endif; ?>
              </tbody>
            </table>
        </div>
      ...
      <form id="cat-form" class="admin-form" method="post" action="../../controller/CategoryController.php">
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;margin-bottom:12px;">
          <div style="display:flex;flex-direction:column;gap:6px;">
            ...
            <input name="name" id="cat-name" required style="width:100%;padding:10px;border-radius:8px;border:1px solid #333;background:#1a1a1a;color:#fff;">
          </div>
          <div style="display:flex;flex-direction:column;gap:6px;">
            <label style="margin:0;color:#aaa;font-size:0.9rem;">Slug (optional)</label>
            <input name="slug" id="cat-slug" style="width:100%;padding:10px;border-radius:8px;border:1px solid #333;background:#1a1a1a;color:#fff;">
          </div>
        </div>
        
        <div style="display:flex;flex-direction:column;gap:6px;margin-bottom:15px;">
          <label style="margin:0;color:#aaa;font-size:0.9rem;">Description</label>
          <textarea name="description" id="cat-desc" required rows="3" style="width:100%;padding:10px;border-radius:8px;border:1px solid #333;background:#1a1a1a;color:#fff;resize:vertical;"></textarea>
        </div>
