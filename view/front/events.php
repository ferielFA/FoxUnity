...
if ($showHistory) {
    ...
    if (!$isLoggedIn) {
        $message = '<div class="alert error"><i class="fas fa-exclamation-circle"></i> Please login to view your participation history.</div>';
        $evenements = [];
    } else {
    ...
    if ($isLoggedIn && $currentUser) {
        ...
        $message = '<div class="alert error"><i class="fas fa-exclamation-circle"></i> Please login to view your events.</div>';
        $evenements = [];
    }
} else {
...
<head>
    ...
    <style>
        ...
        .events-container {
            display:
                <?php echo $showHistory ? 'flex' : 'grid'; ?>
            ;
            <?php if ($showHistory): ?>
                flex-direction: column;
            <?php else: ?>
                        ...
                        <div style="padding: 20px; text-align: center;">
                            <p style="font-size: 18px; margin-bottom: 20px; color: #333;">
                                <i class="fas fa-user-check"
                                    style="color: #4CAF50; font-size: 48px; display: block; margin-bottom: 15px;"></i>
                            ...
                            <div class="form-actions">
                                <a href="events.php?join=<?= $selectedEvent->getIdEvenement() ?>&confirm=1" class="btn-submit"
                    ...
                    foreach ($displayedEvents as $item):
                        ...
                        <div class="event-card event-item" data-event-index="<?= $eventIndex ?>"
                            ...
                            <div class="event-footer">
                                ...
                                ?>
                                <?php if ($isCreator): ?>
                                    <button class="btn-join" disabled style="opacity:0.7;cursor:not-allowed;background:#3b82f6"
                                        onclick="event.stopPropagation();">
                                        <i class="fas fa-crown"></i> <span data-lang-en="You Created This"
                                            data-lang-fr="Vous l'avez créé">You Created This</span>
                                    </button>
