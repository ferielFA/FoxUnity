<?php
/**
 * Project-wide database configuration and connection.
 * 
 * This file defines database constants and provides a Database singleton class
 * for managing PDO connections to the foxunity0 database.
 */
